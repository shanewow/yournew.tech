...
import tech.yournew.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("tech.yournew.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("tech.yournew.repository.search")
